...
# Load your dataset
df = pd.read_csv("/content/drive/MyDrive/Dataset/DrugRecommendation/Training.csv")  # Replace with your actual file path
...
print(f" Randomforest Alternative Accuracy: {accuracy_alt:.4f}")
